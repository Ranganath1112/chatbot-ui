...
AS $$
DECLARE
  project_url TEXT := 'https://avtfvcsztwoqjncclwul.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF2dGZ2Y3N6dHdvcWpuY2Nsd3VsIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NTkxNjY0MiwiZXhwIjoyMDYxNDkyNjQyfQ.4isLKEWU_d7PrKW_Pykbl5l67diLyl-apoGQRBzcw_g'; -- full access needed for http request to storage
